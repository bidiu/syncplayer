...
/**
 * Note that for message sent to client, `currentTime` is optional
 * in case action is `play` and `pause`. Similarly, `paused` is not
 * given in case action is `seeking`.
 * 
 * However, when action is `time_update`, both are given.
 */
